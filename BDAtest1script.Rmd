...
# Emission wavelength:
em_range = c(250,450) 
# changed from (250, 800) to (250, 450) to match the range of the data
# e.g. c(300,500), c(0,Inf) to use everything #changed from (0,Inf) to (250,800)

# Excitation wavelength:
ex_range = c(250,450) 
# changed from (250, 800) to (240, 450) to match the range of the abs data
# e.g. c(300,500), c(0,Inf) to use everything #same as above
