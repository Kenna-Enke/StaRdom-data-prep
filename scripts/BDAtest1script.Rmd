---
title: "BDAtest1script"
author: "Kenna"
date: "7/8/2020"
knit: (function(inputFile, encoding) {
      output_dir = 'C:/Users/Cupcake/Documents/Stardom-data-prep/output';
...
sample_dir = "C:/Users/Cupcake/Documents/StaRdom-data-prep/input/waterfall_new"
input_dir= "C:/Users/Cupcake/Documents/StaRdom-data-prep/input/waterfall_new"
...
# path of adsorbance data as directory or single file, sub folders are not read:
 absorbance_dir = "C:/Users/Cupcake/Documents/StaRdom-data-prep/input/absorbance_new"
#package = "staRdom" 
...
# Emission wavelength:
em_range = c(300,550) 
# Changed to 350 to 550 to capture interesting parts of spectrum
# e.g. c(300,500), c(0,Inf) to use everything #changed from (0,Inf) to (250,800)

# Excitation wavelength:
ex_range = c(240,400) 
# Changed to 240 to 400 to capture interesting parts of spectrum
# # e.g. c(300,500), c(0,Inf) to use everything
...
remove_scatter_width = c(10, 10, 35, 15) # e.g. 15 or c(15,15,15,15) #originally c(15,20,15,18)

# BPC: 1st order Rayleigh has a shoulder 25nm shorter wavelength. This is weird.
# Big width eliminates it, but need to look into this more.
...
raman_normalisation = "blank" # e.g. "blank", FALSE, 160, "meta" # changed from FALSE to "blank" to "meta"
...
if(absorbance_dir != FALSE){
  ...
  if(abs_norm != FALSE){
    if(abs_norm == TRUE) abs_norm <- c(240, 600) # CHANGED C(240, 700) TO C(240,600)
...
# BPC: Set em_range to 250 to 450 and ex_range to 260 to 440 and got the following warning: BD200625S01R1 : 
# absorbance wavelength range is smaller than emission wavelength range, 
# inner-filter effect correction is impossible!
# 
# Set em_range to 250 to 450 and ex_range to 250 to 450
